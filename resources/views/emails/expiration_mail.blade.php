...
<head>
    ...
    <title>Nouveau modC3A8le de courrier C3A9lectronique 2022-06-28</title>
                        ...
                        <tr style="border-collapse:collapse">
                            <td cellpadding="0" cellspacing="0" border="0"
                                style="padding:0;Margin:0;line-height:1px;min-width:600px" height="0"><img
                                    src=" {{ asset('images/' . $details->image) }}"
                                    ...
                                    alt="{{ $details->image }}" width="600" height="1"></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr style="border-collapse:collapse">
                <td valign="top" style="padding:0;Margin:0">
                    ...
                    <table class="es-content" cellspacing="0" cellpadding="0" align="center"
                        ...
                        <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;background-color:#6fa8dc" bgcolor="#6fa8dc" align="center">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td class="es-m-txt-l" bgcolor="#ffffff"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        @php
                                                                            $rodi = alertExpiration($details);
                                                                        @endphp
                                                                    <h1 style="color:red">
                                                                        <strong>{{ $rodi[0]['message'] == '.' ? $rodi[0][0] : $rodi[0]['message'] }}
                                                                        </strong></h1>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <a target="_blank"
                                                                        href="{{ url('http://127.0.0.1:8000/home') }}"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#3d85c6;font-size:18px">click
                                                                        here to join your admin account</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        class="adapt-img"
                                                                        src="https://jrfwry.stripocdn.email/content/guids/CABINET_29bfd058432fca91d297d83351a4fd04/images/unstim.jpeg"
                                                                        alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="225"></td>
                                                            </tr>

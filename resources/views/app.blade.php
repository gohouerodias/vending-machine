...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a
                    ...
                    href="{{ url('home') }}">
                    <div class="sidebar-brand-icon "><svg xmlns="http://www.w4.org/2000/svg" width="36" height="36"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" class="feather feather-trending-up">
                            <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline>
                            <polyline points="17 6 23 6 23 12"></polyline>
                        </svg></div>
                    <div class="sidebar-brand-text mx-3"><span>AID SELl</span></div>
                </a>
                <hr class="sidebar-divider my-0">
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link {{ request()->is('home') ? 'active' : '' }}"
                            href="{{ url('home') }}"><i class="fas fa-tachometer-alt"></i><span>Statistique de
                                vente</span></a></li>
                    <li class="nav-item"><a class="nav-link {{ request()->is('profile') ? 'active' : '' }} "
                            href="{{ url('profile') }}"><i class="fas fa-user"></i><span>Profile</span></a></li>
                    <li class="nav-item"><a
                            class="nav-link {{ request()->is('conservation') ? 'active' : '' }} "
                            href="{{ url('conservation') }}"><i
                                class="fas fa-table"></i><span>Conservation</span></a></li>
    ...
    <script src="{{ asset('assets/js/Menu-Modal-Element.js') }}"></script>
